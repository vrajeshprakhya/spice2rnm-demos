...
\begin{itemize}[leftmargin=1.5em,itemsep=0.3em]
  ...
  \item \textbf{A UVM-MS verification environment} following the Accellera
        ...
        injector, a second bridge. The default output contains no
        \texttt{wreal} and needs no AMS licence to run. Bridge and wrapper ports are
...
a failure twelve minutes into a run. spice2rnm's outputs are
