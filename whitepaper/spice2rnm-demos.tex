...
both, it passes both. Give them the same moving control and one produces
$28.6\times$ the period jitter the transistors produce.
...
circuit gives $3.02\unit{ps}$, and the ratio $0.214$ is
$\sqrt{100\unit{ps}/2500\unit{ps}}$: the oscillator averages its input
over the cycle. The model reproduces that because it integrates, and the
version that samples does not.
