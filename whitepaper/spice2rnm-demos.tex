...
characterisation and the reference transients, \textbf{xezim} for the
transient equivalence co-simulation, and \textbf{Icarus Verilog} for the
generated UVM-MS environments. No commercial licence was used anywhere in
this document. The generated artifacts themselves --- the
