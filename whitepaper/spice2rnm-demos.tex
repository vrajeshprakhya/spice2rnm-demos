...
$19$ minutes, most of it the ring oscillator's tuning curve, and unlike
the others it is not self-contained: it needs the co-simulation it is
modelled from, which supplies the RTL, the DPI bridge and a shared
libngspice. It is presented here as a case study rather than as a fourth
one-command demo for that reason. spice2rnm's outputs are simulator-agnostic ---
