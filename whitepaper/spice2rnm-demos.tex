...
\begin{itemize}[leftmargin=1.5em,itemsep=0.3em]
  ...
  \item \textbf{A UVM-MS verification environment} following the Accellera
        ...
        injector, a second bridge. The environment instantiates
        ...
        \texttt{wreal}, so running it needs a simulator providing that;
        \texttt{-{}-model-ports real} removes the dependence for a flow
        without it. Bridge and wrapper ports are
