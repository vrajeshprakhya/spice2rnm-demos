...
//
// Tuning curve: 15 points measured from SPICE over 0.49..2.80 V
...
// In the MEASURED OPERATING BAND 1.6500..2.0500 V, taken from a golden
// co-simulation run before this model existed: 0.023% (0.6 ps) over 5
// held-out point(s), worst at 1.9000 V.
...
module ro_vco_rnm #(
  ...
  parameter real DFDV_SUP = 4.506279646e+08,  // Hz per volt of supply
  ...
  function automatic void load_tab();
      ...
      VC[5] = 1.750000; FO[5] = 4.387292022e+08;
      VC[6] = 1.850000; FO[6] = 3.998617212e+08;
      VC[7] = 1.938750; FO[7] = 3.658689447e+08;
      VC[8] = 1.950000; FO[8] = 3.616114645e+08;
      VC[9] = 2.050000; FO[9] = 3.241480087e+08;
      VC[10] = 2.227500; FO[10] = 2.570119652e+08;
      VC[11] = 2.516250; FO[11] = 1.366251648e+08;
      VC[12] = 2.660625; FO[12] = 7.416278165e+07;
      VC[13] = 2.732812; FO[13] = 4.240882586e+07;
      VC[14] = 2.805000; FO[14] = 1.673948453e+07;
    tab_loaded = 1'b1;
  endfunction
