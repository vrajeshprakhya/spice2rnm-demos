...
// In the MEASURED OPERATING BAND 1.7967..1.9049 V, taken from a golden
// co-simulation run before this model existed: 0.002% (0.1 ps) over 4
// held-out point(s), worst at 1.8914 V.
...
module ro_vco_rnm #(
  ...
  parameter real DFDV_SUP = 4.506322528e+08,  // Hz per volt of supply
  ...
  function automatic void load_tab();
      ...
      VC[5] = 1.796733; FO[5] = 4.205357663e+08;
      VC[6] = 1.823781; FO[6] = 4.100217276e+08;
      VC[7] = 1.850828; FO[7] = 3.995413847e+08;
      VC[8] = 1.877876; FO[8] = 3.891102973e+08;
      VC[9] = 1.904924; FO[9] = 3.787409638e+08;
